...
@Component({
    selector: 'management-services-detail',
    templateUrl: '../template/management-services-detail.component.html',
    styleUrls: ['../style/management-services-detail.less'],
})

export class ManagementServicesDetailComponent implements OnInit {
...
// }
    ...
    constructor(
        ...
        private service: ManagementServicesDetailService
    ) {
