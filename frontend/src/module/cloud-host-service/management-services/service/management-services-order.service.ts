...
export class ManagementServicesOrderService {
    ...
    fetchProductInfo(productId: string): Promise<any> {
    ...
    fetchProductCategory(productId: string): Promise<SuperviseServiceDetailInfoItem> {
        const api = this.restApiCfg.getRestApi("product-list-via-serviceId");
