...
@Component({
	selector: 'middleware-detail',
	templateUrl: '../template/middleware-detail.component.html',
	styleUrls: ['../style/middleware-detail.less'],
})
...
export class MiddlewareDetailComponent implements OnInit {
	...
	constructor(
		...
		private service: MiddlewareDetailService
	) {
		this.setGraph()
	}
