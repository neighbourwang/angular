...
@Component({
	selector: 'middleware-list',
	templateUrl: '../template/middleware-list.component.html',
	styleUrls: ['../style/middleware-list.less'],
})
...
export class MiddlewareListComponent implements OnInit, OnDestroy {
	...
	vmList: VmList[] = [];   //主机
	handleData: HandleVm;   //发送操纵中间件的数据
	labelItem:MiddlewareLabelItem[] = [];
	...
	constructor(
		...
		private service: MiddlewareServiceList
	) {
