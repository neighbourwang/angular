...
@Component({
	...
	templateUrl: '../template/database-list.component.html',
	styleUrls: ['../style/database-list.less'],
})
...
export class DatabaseListComponent implements OnInit, OnDestroy {
	...
	vmList: VmList[] = [];   //主机
	handleData: HandleVm;   //发送操纵数据库的数据
	labelItem:DatabaseLabelItem[] = [];
	...
	constructor(
		...
		private service: DatabaseServiceList
	) {
