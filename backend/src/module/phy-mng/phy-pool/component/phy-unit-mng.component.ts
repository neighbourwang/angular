...
export class PhyUnitMngComponent implements OnInit {
        ...
        this.service.getPartsList()
            ...
            response => {
                ...
                if (response && 100 == response["resultCode"]) {
                    ...
                    //    this.selectedParts = this.partslist[0];
                    //    if (this.selectedParts.specList.length > 0) {
                    //        this.selectedSpec = this.selectedParts.specList[0];
                    //    }
                    //}
                } else {
                    this.showAlert("COMMON.OPERATION_ERROR");
    ...
    creOredit() {
        ...
        this.criteria.specName = (this.defaultSpec.specName != this.partsName.nativeElement.value && this.specName.nativeElement.value) || this.criteria.specName;
