...
export class VmDisIndexComponent implements OnInit {
    ...
    //        return;
    //    }
    //    this.noticeMsg = `您选择启用 '${selectedPort.portDisplayName}'端口组，其端口组名称为${selectedPort.portGroupName}' ， 
    ...
    //        return;
    //    }
    //    this.noticeMsg = `您选择禁用 '${selectedPort.portDisplayName}'端口组，其端口组名称为${selectedPort.portGroupName}' ， 
