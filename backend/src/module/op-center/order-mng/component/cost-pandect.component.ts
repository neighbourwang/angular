...
import { DateItem,CostPandectParam,SubInstanceResp, AdminListItem, DepartmentItem, Platform, ProductType, SubRegion, OrderMngParam} from '../model'
...
dateItem:DateItem = new DateItem();//年份、月份下拉
//订单类型
