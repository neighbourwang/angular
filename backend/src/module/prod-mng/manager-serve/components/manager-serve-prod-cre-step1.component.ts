...
export class ManagerServeProdCreStep1Component implements OnInit {
    ...
    checkForm(key?: string) {
        let regs: ValidationRegs = {  //regs是定义规则的对象
            productName: [this.service.managerServeProduct.name, [this.v.isBase, this.v.isUnBlank,this.v.minLength(2),this.v.maxLength(50)], "产品名称格式不正确"],

            description: [this.service.managerServeProduct.description, [this.v.maxLength(255)], "描述输入错误"],
